...
class TopRankedChipFilteredFragment : Fragment()  {
    ...
    ) = inflater.inflate(R.layout.fragment_top_ranked_chip_filtered, container, false)
    ...
    private fun populateRestaurantList(view: View, savedInstanceState: Bundle?) {
        ...
        db.collection("restaurant").orderBy("overallRating", Query.Direction.DESCENDING).get().addOnSuccessListener { documentCollection ->
